...
namespace ModelParaOptExcelAddIn.ConstitiveModel
{
    ...
    {
        // other information 
        public static double[] LowerBound = new double[] { 0.5, 0.1, 0.0001, 0.001, 0.400, 0.200, 0.00, 0.00 };
        public static double[] UpperBound = new double[] { 2.00, 0.4, 0.2000, 0.650, 3.500, 3.000, 0.99, 25.00 };
        public static int[] DecimalNumber = new int[] { 2, 1, 4, 3, 3, 3, 2, 2 };

        public static string ConstitiveModelShortName = "CSUH";
        public static string ConstitiveModelLongName = "Unified Harding model for Clays and Sands";

        public static int[,] arrParaNum = new int[,] { { 1 }, { 2 }, { 3 }, { 4 }, { 5 }, { 6 }, { 7 }, { 8 } };
        public static string[,] ParaName = new string[,] { { "M" }, { "ν" }, { "κ" }, { "λ" }, { "N" }, { "Z" }, { "χ" }, { "m" } };
        ...
        public void ModelCompute(double[] para, double sc, double e0, double b)
        {
            ...
            for (int i = 0; i < number - 1; i++)
            {
                ...
                I3 = S1[i] * S2[i] * S3[i];//
                denominatorOfF = I1 * I2 - 9.0 * I3;
                if (denominatorOfF < 1E-20) denominatorOfF = 1E-20;
                F = Math.Sqrt((I1 * I2 - I3) / denominatorOfF);
                qc = 2.0 * I1 / (3.0 * F - 1);//   q in SMP 
                q[i] = 2.0 * I1 / (3.0 * F - 1);//q in transformational stress space ,q=qc 
                p[i] = I1 / 3.0;//p in transformational stress space
                ...
                eVoidRatio[i + 1] = e0 - ev[i + 1] * (1 + e0);//void ratio 孔隙比=Vs/Vv
